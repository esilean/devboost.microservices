...
Esquema do Cenario: Receber valores do cartao de credito e pagar o pedido
	Dado Que eu tenha um pedido receba um NumeroCartao: '<numeroCartao>' Vencimento: '<vencimento>' CodigoSeguranca: '<codigoSeguranca>'
	Quando eu solicitar a realização do pagamento
	Entao o pedido deverá ser pago a resposta devera ser um status code 200OK
	Exemplos: 
